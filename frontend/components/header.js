...
export function MidlleNAvFormSmallScreen() {
    return (
        <div className={`${styles.middleContent} ${styles.middleContent1}`}>
            <Link href="/home"><i className="active fas fa-home"><span>25+</span></i></Link>
        ...
        <>
            ...
            {isMenuOpen && (
                <div className={styles.dropdownMenu}>
                    <ul>
                        <li><Link href='/profileuser'><i className="fa-regular fa-user"></i>Profile</Link> </li>
                        <li onClick={PostForm}>  <i className="fa-solid fa-pen-to-square"></i>Create post</li>
                        <li onClick={GroupForm}> <i className="fa-solid fa-users" ></i>Create group</li>
                        <li><Link href='/'><i className="fa-solid fa-arrow-right-from-bracket"></i>log out</Link></li>
                    </ul>
                </div>
            )}
